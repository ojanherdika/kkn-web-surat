                ...
                <div class="col-lg-12">
                    ...
                    <div class="container-fluid shadow p-3  mb-3 bg-white rounded mt-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>NIK</label>
                                <input class="form-control" name="nik_ayah" type="text" placeholder="Masukan NIK Ayah">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Agama</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>NIK</label>
                                <input class="form-control" name="nik_ibu" type="text" placeholder="Masukan NIK Ibu">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Agama</label>
