<?php 
        ...
        $pdf->ln();
        $pdf->Cell(20,5,'Tempat dan tanggal lahir:'.$surat->tempat_lahir_ayah.", ".tgl_indo($surat->tanggal_lahir_ayah),0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Kewarganaan:'. $surat->kewarganegaraan_ayah,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Agama:'.$surat->agama_ayah,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Pekerjaan:'.$surat->pekerjaan_ayah,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Alamat:'.$surat->alamat_ayah." RT ".$surat->rt_ayah." RW ".$surat->rw_ayah,0,0);
        $pdf->ln(10);
        $pdf->Cell(20,5,'dengan seorang wanita:',0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Nama Lengkap dan alias:'.$surat->nama_ibu,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Nomor Induk Kependudukan (NIK):'.$surat->nik_ibu,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Tempat dan tanggal lahir:'.$surat->tempat_lahir_ibu.", ".tgl_indo($surat->tanggal_lahir_ibu),0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Kewarganaan:'.$surat->kewarganegaraan_ibu,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Agama:'.$surat->agama_ibu,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Pekerjaan:'.$surat->pekerjaan_ibu,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'Alamat:'.$surat->alamat_ibu." RT ".$surat->rt_ibu." RW ".$surat->rw_ibu,0,0);
        $pdf->ln(10);
