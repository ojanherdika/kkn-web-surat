<?php 
        ...
        $pdf->ln();
        $pdf->Cell(20,5,'1. Nama:'.$surat->nama_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'2. Bin/Binti:'.$surat->binti_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'3. Nomor Induk Kependudukan:'.$surat->nik_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'4. Tempat dan tanggal lahir : '.$surat->tempat_lahir_mati.", ".tgl_indo($surat->tanggal_lahir_mati),0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'5. Kewarganegaraan:'.$surat->kewarganegaraan_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'6. Agama:'.$surat->agama_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'7. Pekerjaan:'.$surat->pekerjaan_mati,0,0);
        $pdf->ln();
        $pdf->Cell(20,5,'8. Alamat:'.$surat->alamat_mati." RT ".$surat->rt_mati." RW ".$surat->rw_mati,0,0);
        $pdf->ln(10);
        $pdf->Cell(20,5,'Telah menginggal dunia pada tanggal : '.tgl_indo($surat->tgl_meninggal),0,0);
        $pdf->ln(10);
        $pdf->Cell(20,5,'Di : '.$surat->tempat_meninggal,0,0);
        $pdf->ln(10);
